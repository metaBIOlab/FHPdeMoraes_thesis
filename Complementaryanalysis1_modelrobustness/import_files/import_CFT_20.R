...
data_longcor_ses1_20 <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/resultados/data_longcor_ses1_20mm.txt")

data_longcor_ses1_20 <- data_longcor_ses1_20 %>% mutate(
  SUBJ = SubjectID,
  hemi = Hemisphere,
  ROI = "hemisphere",
...
data_longcor_ses1_20$hemi[data_longcor_ses1_20$hemi == "left"] <- "L"
data_longcor_ses1_20$hemi[data_longcor_ses1_20$hemi == "right"] <- "R"

# LOBOS----

# data_longcor_ses1_lobes_20 <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/resultados/data_longcor_ses1_lobes_20mm.txt")
# 
# data_longcor_ses1_lobes_20 <- data_longcor_ses1_lobes_20 %>% mutate(
#   SUBJ = SubjectID,
#   hemi = Hemisphere,
#   ROI = Lobe,
#   method = "CorticalFoldingTool",
...
# 
# data_longcor_ses1_lobes_20$hemi[data_longcor_ses1_lobes_20$hemi == "left"] <- "L"
# data_longcor_ses1_lobes_20$hemi[data_longcor_ses1_lobes_20$hemi == "right"] <- "R"
# 
# data_longcor_ses1_lobes_20$ROI[data_longcor_ses1_lobes_20$ROI == 1] <-
#   "F"
# data_longcor_ses1_lobes_20$ROI[data_longcor_ses1_lobes_20$ROI == 2] <-
#   "P"
# data_longcor_ses1_lobes_20$ROI[data_longcor_ses1_lobes_20$ROI == 3] <-
#   "T"
# data_longcor_ses1_lobes_20$ROI[data_longcor_ses1_lobes_20$ROI == 4] <-
#   "O"
# # data_longcor_ses1_lobes_20$nROI[data_longcor_ses1_lobes_20$nROI == 5] <- "Insula"
# 
# data_longcor_ses1_lobes_20$ROI <- as.factor(data_longcor_ses1_lobes_20$ROI)
