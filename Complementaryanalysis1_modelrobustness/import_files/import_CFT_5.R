...
data_longcor_ses1_5 <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/resultados/data_longcor_ses1_5mm.txt")

data_longcor_ses1_5 <- data_longcor_ses1_5 %>% mutate(
  SUBJ = SubjectID,
  hemi = Hemisphere,
  ROI = "hemisphere",
...
data_longcor_ses1_5$hemi[data_longcor_ses1_5$hemi == "left"] <- "L"
data_longcor_ses1_5$hemi[data_longcor_ses1_5$hemi == "right"] <- "R"

# LOBOS----

# data_longcor_ses1_lobes_5 <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/resultados/data_longcor_ses1_lobes_5mm.txt")
# 
# data_longcor_ses1_lobes_5 <- data_longcor_ses1_lobes_5 %>% mutate(
#   SUBJ = SubjectID,
#   hemi = Hemisphere,
#   ROI = Lobe,
#   method = "CorticalFoldingTool",
...
# 
# data_longcor_ses1_lobes_5$hemi[data_longcor_ses1_lobes_5$hemi == "left"] <- "L"
# data_longcor_ses1_lobes_5$hemi[data_longcor_ses1_lobes_5$hemi == "right"] <- "R"
# 
# data_longcor_ses1_lobes_5$ROI[data_longcor_ses1_lobes_5$ROI == 1] <-
#   "F"
# data_longcor_ses1_lobes_5$ROI[data_longcor_ses1_lobes_5$ROI == 2] <-
#   "P"
# data_longcor_ses1_lobes_5$ROI[data_longcor_ses1_lobes_5$ROI == 3] <-
#   "T"
# data_longcor_ses1_lobes_5$ROI[data_longcor_ses1_lobes_5$ROI == 4] <-
#   "O"
# # data_longcor_ses1_lobes_5$nROI[data_longcor_ses1_lobes_5$nROI == 5] <- "Insula"
# 
# data_longcor_ses1_lobes_5$ROI <- as.factor(data_longcor_ses1_lobes_5$ROI)
