...
data_longcor_ses1_50 <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/resultados/data_longcor_ses1_50mm.txt")

data_longcor_ses1_50 <- data_longcor_ses1_50 %>% mutate(
  SUBJ = SubjectID,
  hemi = Hemisphere,
  ROI = "hemisphere",
...
data_longcor_ses1_50$hemi[data_longcor_ses1_50$hemi == "left"] <- "L"
data_longcor_ses1_50$hemi[data_longcor_ses1_50$hemi == "right"] <- "R"

# LOBOS----

# data_longcor_ses1_lobes_50 <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/resultados/data_longcor_ses1_lobes_50mm.txt")
# 
# data_longcor_ses1_lobes_50 <- data_longcor_ses1_lobes_50 %>% mutate(
#   SUBJ = SubjectID,
#   hemi = Hemisphere,
#   ROI = Lobe,
#   method = "CorticalFoldingTool",
...
# 
# data_longcor_ses1_lobes_50$hemi[data_longcor_ses1_lobes_50$hemi == "left"] <- "L"
# data_longcor_ses1_lobes_50$hemi[data_longcor_ses1_lobes_50$hemi == "right"] <- "R"
# 
# data_longcor_ses1_lobes_50$ROI[data_longcor_ses1_lobes_50$ROI == 1] <-
#   "F"
# data_longcor_ses1_lobes_50$ROI[data_longcor_ses1_lobes_50$ROI == 2] <-
#   "P"
# data_longcor_ses1_lobes_50$ROI[data_longcor_ses1_lobes_50$ROI == 3] <-
#   "T"
# data_longcor_ses1_lobes_50$ROI[data_longcor_ses1_lobes_50$ROI == 4] <-
#   "O"
# # data_longcor_ses1_lobes_50$nROI[data_longcor_ses1_lobes_50$nROI == 5] <- "Insula"
# 
# data_longcor_ses1_lobes_50$ROI <- as.factor(data_longcor_ses1_lobes_50$ROI)
