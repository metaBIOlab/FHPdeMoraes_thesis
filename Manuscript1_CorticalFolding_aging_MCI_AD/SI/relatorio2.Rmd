...
ggplot(
  ...
  geom_point() + geom_errorbar(aes(ymin = estimate - std.error, ymax = estimate + std.error)) + geom_hline(yintercept = 1.25, linetype = "dashed") + theme_pubr() + labs(y = "slope", x = "Institution", caption = "Only healthy subjects") + 
  theme(
    axis.title = element_text(size = 11),
    axis.text = element_text(size = 10),
    text = element_text(size = 10),
...
ggplot(filter(dados_datasetscomp, ROI == "hemisphere", Diagnostic == "CTL", Sample != "AHEAD", Sample != "HCP500r"), aes(Age, K)) +
  ...
  stat_cor()+
  theme_pubr()+ labs(caption = paste("Only healthy subjects, N=",n_distinct(filter(dados_datasetscomp, ROI == "hemisphere", Diagnostic == "CTL", Sample != "AHEAD", Sample != "HCP500r")$SUBJ))) + theme(
    axis.title = element_text(size = 11),
    axis.text = element_text(size = 10),
    text = element_text(size = 10),
    axis.text.x = element_text(angle = 45, hjust = 1, size=9))
...
ggplot(filter(dados_datasetscomp, ROI != "hemisphere", Diagnostic == "CTL", Sample != "AHEAD", Sample != "HCP500r"), aes(Age, K)) +
  ...
  geom_smooth(method="lm", linetype = "dashed", se = TRUE, color = "black", alpha = 0.5) +
  stat_cor()+
  theme_pubr() + facet_grid(ROI ~ .)+ labs(caption = "Only healthy subjects") + theme(
    axis.title = element_text(size = 11),
    axis.text = element_text(size = 10),
    text = element_text(size = 10),
    axis.text.x = element_text(angle = 45, hjust = 1, size=9))
...
ggplot(data = dados_datasetscomp, aes(x = Sample, y = K_age_decay, color = Diagnostic, fill = Diagnostic, alpha = 0.4)) + 
  geom_boxplot() + theme_pubr() +
  stat_compare_means(method = "anova") + theme(
    axis.title = element_text(size = 11),
    axis.text = element_text(size = 10),
    text = element_text(size = 10),
    axis.text.x = element_text(angle = 45, hjust = 1, size=9))
...
ggplot(filter(dados_datasetscomp_MH, ROI == "hemisphere"), aes(x = Family, y = K/sqrt(1 + (1/4)^2 + (5/4)^2), color = Family, fill = Family, alpha = 0.4)) +
         geom_boxplot()+
         theme_pubr() +
  guides(alpha = FALSE) + 
  theme(
...
ggplot(filter(dados_datasetscomp_MH, ROI == "hemisphere"), aes(x = Family, y = 10^(K/sqrt(1 + (1/4)^2 + (5/4)^2)), color = Family, fill = Family, alpha = 0.4)) +
         geom_boxplot()+
         theme_pubr() +
  guides(alpha = FALSE) + 
  theme(
...
ggplot(filter(dados_datasetscomp_MH, ROI == "hemisphere"), aes(Family, S/sqrt((3/2)^2 + (3/4)^2 + (9/4)^2), color = Family, fill = Family, alpha = 0.4)) +
         geom_boxplot()+
         theme_pubr() +
  guides(alpha = FALSE) + 
  theme(
...
ggplot(filter(dados_datasetscomp_MH, ROI == "hemisphere"), aes(Family, 10^(S/sqrt((3/2)^2 + (3/4)^2 + (9/4)^2)), color = Family, fill = Family, alpha = 0.4)) +
         geom_boxplot()+
         theme_pubr() +
  guides(alpha = FALSE) + 
  theme(
...
ggplot(data = dados_datasetscomp_MH, aes(logExposedArea, 1 / 2 * logAvgThickness + logTotalArea)) +
  geom_smooth(method = "lm", se = FALSE) +
  # geom_text(
  #     nudge_x = 0.3,
  #     label = ifelse(
...
modela2 <- ggplot(data = dados_datasetscomp_MH, aes(I, S)) +
  geom_smooth(method = "lm", se = FALSE) +
  # geom_text(
  #   nudge_x = 0.3,
  #   label = ifelse(
...
modelb2 <- ggplot(data = dados_datasetscomp_MH
                  , aes(K, S)) +
  geom_smooth(method = "lm", se = FALSE) +
  # geom_text(
  #   nudge_x = 0.3,
...
#ggsave("figS3.png", plot = figS3, dpi=1200, width = 16, height = 11, units = "cm", device = "png")
...
#ggsave("healthyvalues.png", plot = healthyvalues, dpi=1200, width = 18, height = 22, units = "cm", device = "png")
...
ggsave("model_micro.png", plot = model_micro, dpi=1200, width = 18, height = 11, units = "cm", device = "png")
...
dados_datasetscomp$Family[dados_datasetscomp$Sample == "IDOR-ZKMICRO" | dados_datasetscomp_MH_2$Sample == "IDOR-MICRO"] <- "Hominidae"

dados_datasetscomp$Species[dados_datasetscomp$Sample == "IDOR-ZKMICRO"] <- "Homo sapiens ZKMICRO"
dados_datasetscomp$Species[dados_datasetscomp$Sample == "IDOR-MICRO"] <- "Homo sapiens MICRO"


dados_datasetscomp_zoom <- filter(dados_datasetscomp,
                                       S < 11 &
                                         S > 8.5 &
                                         Species != "Homo sapiens" & I > 8)

dados_datasetscomp_zoom$Species <- as.factor(dados_datasetscomp_zoom$Species)
...
ggsave("modelzoom.png", plot = modelzoom, dpi=1200, width = 16, height = 11, units = "cm", device = "png")
...
ggsave("simu_allsamples.png", plot = simu_allsamples, dpi=1200, width = 18, height = 22, units = "cm", device = "png")

```

```{r}
dados_zk <- filter(dados_datasetscomp, Sample == "IDOR-ZK" | Sample == "IDOR-CHIK" | Sample == "IDOR-ZKMICRO" | Sample == "IDOR-OUTROS" | Sample == "IDOR-PRESZK")
dados_zk$Sample <- as.factor(dados_zk$Sample)  

cols2 = gg_color_hue(length(levels(dados_zk$Sample)))
cols2[levels(dados_zk$Sample)=="IDOR-ZKMICRO"]="black"

model_all_zk <- ggplot(data = filter(dados_zk, ROI == "hemisphere"), aes(logExposedArea, 1 / 2 * logAvgThickness + logTotalArea)) +
  geom_smooth(method = "lm", se = FALSE) +
  # geom_text(
  #     nudge_x = 0.3,
  #     label = ifelse(
...
ggsave("model_all_fig.png", plot = model_all_fig, dpi=1200, width = 18, height = 11, units = "cm", device = "png")
```
...
ggsave("zk.png", plot = zk, dpi=1200, width = 18, height = 22, units = "cm", device = "png")
...
ggsave("ZK_boxplot.png", plot = ZK_boxplot, dpi=1200, width = 18, height = 12, units = "cm", device = "png")
...
ggsave("ZK_tukey.png", plot = ZK_tukey, dpi=1200, width = 18, height = 22, units = "cm", device = "png")
```
...
figS4a <- ggplot(
  ...
  geom_line(aes(group = Sample)) +
  geom_errorbar(aes(ymin = estimate - std.error, ymax = estimate + std.error)) +
  geom_hline(data = filter(amostras_Coef_CTL, term == "logExposedArea", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control"), aes(yintercept = estimate, color = Sample)) + 
...
ggplot(
  filter(dados_datasetscomp, ROI == "hemisphere", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control"),
  aes(logExposedArea, 1 / 2 * logAvgThickness + logTotalArea, color = Sample, fill = Sample)
  ) +
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  ...
  theme_pubr() + labs(caption = paste(
  "Humanos de todos os diagnosticos, apenas 1 visita, N = ",
  n_distinct(filter(dados_datasetscomp, ROI == "hemisphere", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control")$SUBJ)
  ))

ggplot(
  filter(dados_datasetscomp, ROI == "hemisphere", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control"| Sample == "IDOR-AD" | Sample == "IDOR-MCI"),
  aes(logExposedArea, 1 / 2 * logAvgThickness + logTotalArea, color = Sample, fill = Sample)
  ) +
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  ...
  theme_pubr() + labs(caption = paste(
  "Humanos de todos os diagnosticos, apenas 1 visita, N = ",
  n_distinct(filter(dados_datasetscomp, ROI == "hemisphere", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control"| Sample == "IDOR-AD" | Sample == "IDOR-MCI")$SUBJ)
  ))


aov_thick <- aov(AvgThickness ~ Sample, data = filter(dados_datasetscomp, ROI == "hemisphere", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control"))
summary(aov_thick)
#TukeyHSD(aov_thick)
...
ggplot(
  filter(
    dados_datasetscomp,
    ROI == "hemisphere",
    Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control"
  ),
  aes(
    x = Sample,
    y = logAvgThickness,
...
aov_thick <- aov(AvgThickness ~ Sample*Age_interval10, data = filter(dados_datasetscomp, ROI == "hemisphere", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control", Age_interval != "80-85"))
summary(aov_thick)
#TukeyHSD(aov_thick)


aov_thick <- aov(AvgThickness ~ Sample, data = filter(dados_datasetscomp, ROI == "hemisphere", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control"| Sample == "IDOR-AD" | Sample == "IDOR-MCI"))
summary(aov_thick)
#TukeyHSD(aov_thick)
...
ggplot(
  filter(
    dados_datasetscomp,
    ROI == "hemisphere",
    Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control"| Sample == "IDOR-AD" | Sample == "IDOR-MCI" 
  ),
  aes(
    x = Sample,
    y = logAvgThickness,
...
aov_thick <- aov(AvgThickness ~ Sample*Age_interval10, data = filter(dados_datasetscomp, ROI == "hemisphere", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control"| Sample == "IDOR-AD" | Sample == "IDOR-MCI"))
summary(aov_thick)
#TukeyHSD(aov_thick)
...
#ggsave("figS4.png", dpi=1200, width = 18, height = 9, units = "cm", device = "png")


ggplot(
  filter(dados_datasetscomp, ROI == "hemisphere", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control"), aes(Age, K, color = Sample, fill = Sample)) +
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_pubr() + labs(caption = paste(
  "Humanos de todos os diagnosticos, apenas 1 visita, N = ",
...
#ggsave("figS5.png", dpi=1200, width = 11, height = 11, units = "cm", device = "png")

ggplot(
  filter(dados_datasetscomp, ROI == "hemisphere", Sample == "AOMICPIOP1-Control" | Sample == "IDOR-Control" | Sample == "AHEAD-Control"),
  aes(logExposedArea, 1 / 2 * logAvgThickness + logTotalArea, color = Sample, fill = Sample)
  ) +
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
