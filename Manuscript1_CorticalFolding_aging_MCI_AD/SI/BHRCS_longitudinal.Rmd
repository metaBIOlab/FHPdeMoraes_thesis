...
dados <- dados_datasetscomp %>% filter(Sample == "BHRCS-SP" | Sample == "BHRCS-POA")
...
ggplot(filter(dados, ROI == "hemisphere"),
       aes(x = Age, y = AvgThickness, color = cohort, fill = cohort)) +
    geom_point(alpha = 0.1) +
    geom_smooth(color = "black", linetype = 2, alpha = 0.5) +
...
ggplot(filter(dados, ROI == "hemisphere"),
       aes(x = Age, y = K, color = cohort, fill = cohort)) +
    geom_point(alpha = 0.1) +
    geom_smooth(color = "black", linetype = 2, alpha = 0.5) +
    geom_smooth(method = "lm") +
    theme_pubr() +
...
ggplot(filter(dados, ROI == "hemisphere"),
       aes(x = Age, y = S, color = cohort, fill = cohort)) +
    geom_point(alpha = 0.1) +
    geom_smooth(color = "black", linetype = 2, alpha = 0.5) +
    geom_smooth(method = "lm") +
    theme_pubr() +
...
ggplot(filter(dados, ROI == "hemisphere"),
       aes(x = Age, y = I, color = cohort, fill = cohort)) +
    geom_point(alpha = 0.1) +
    geom_smooth(color = "black", linetype = 2, alpha = 0.5) +
    geom_smooth(method = "lm") +
    theme_pubr() +
...
## Outlier
```{r}
filter(dados, K < -0.6) %>% dplyr::select(SUBJ, Session, Run, ROI, K)
```

## AvgThickness
```{r eval=FALSE, include=FALSE}
N_SUBJ <- filter(dados, ROI == "hemisphere") %>% summarise(N_SUBJ = n_distinct(SUBJ))

m.0 <- lmerTest::lmer(AvgThickness ~ Age  + (1|SUBJ), data = filter(dados, ROI == "hemisphere"))
m.1 <- lmerTest::lmer(AvgThickness ~ Age * Gender + (1|SUBJ), data = filter(dados, ROI == "hemisphere"))
...
## K
```{r eval=FALSE, include=FALSE}
m.0 <- lmerTest::lmer(K ~ Age  + (1|SUBJ), data = filter(dados, ROI == "hemisphere"))
m.1 <- lmerTest::lmer(K ~ Age * Gender + (1|SUBJ), data = filter(dados, ROI == "hemisphere"))
...
## S
```{r eval=FALSE, include=FALSE}
m.0 <- lmerTest::lmer(S ~ Age  + (1|SUBJ), data = filter(dados, ROI == "hemisphere"))
m.1 <- lmerTest::lmer(S ~ Age * Gender + (1|SUBJ), data = filter(dados, ROI == "hemisphere"))
...
## I
```{r eval=FALSE, include=FALSE}
m.0 <- lmerTest::lmer(I ~ Age  + (1|SUBJ), data = filter(dados, ROI == "hemisphere"))
m.1 <- lmerTest::lmer(I ~ Age * Gender + (1|SUBJ), data = filter(dados, ROI == "hemisphere"))
