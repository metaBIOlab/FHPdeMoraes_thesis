...
summary_dados_machine <- filter(dados_all, Session == 1) %>%
  ...
  summary_dados_machine %>% kable() %>% kable_styling()
...
## COMPARANDO PROCESSAMENTOS
```{r}

dados_processing <- filter(dados_all, !is.na(Longitudinal_correction), ROI == "hemisphere")
dados_processing_ctl <- filter(dados_processing, Diagnostic == "CONTROLE")

ggplot(data = dados_processing_ctl, aes(x = AvgThickness , color = Longitudinal_correction, fill = Longitudinal_correction, alpha = 0.3)) + geom_density()+theme_pubclean() + facet_grid(Session ~ . )

ggplot(data = dados_processing_ctl, aes(x = AvgThickness, y = Longitudinal_correction , color = Longitudinal_correction, fill = Longitudinal_correction, alpha = 0.3)) + geom_boxplot()+theme_pubclean() + facet_grid(Session ~ . ) + stat_compare_means(method = "t.test")

ggplot(data = dados_processing_ctl, aes(x = TotalArea , color = Longitudinal_correction, fill = Longitudinal_correction, alpha = 0.3)) + geom_density()+theme_pubclean() + facet_grid(Session ~ . )

ggplot(data = dados_processing_ctl, aes(x = TotalArea, y = Longitudinal_correction , color = Longitudinal_correction, fill = Longitudinal_correction, alpha = 0.3)) + geom_boxplot()+theme_pubclean() + facet_grid(Session ~ . ) + stat_compare_means(method = "t.test")

ggplot(data = dados_processing_ctl, aes(x = WhiteSurfArea , color = Longitudinal_correction, fill = Longitudinal_correction, alpha = 0.3)) + geom_density()+theme_pubclean() + facet_grid(Session ~ . )

ggplot(data = dados_processing_ctl, aes(x = WhiteSurfArea, y = Longitudinal_correction , color = Longitudinal_correction, fill = Longitudinal_correction, alpha = 0.3)) + geom_boxplot()+theme_pubclean() + facet_grid(Session ~ . ) + stat_compare_means(method = "t.test")

ggplot(data = dados_processing_ctl, aes(x = localGI , color = Longitudinal_correction, fill = Longitudinal_correction, alpha = 0.3)) + geom_density()+theme_pubclean() + facet_grid(Session ~ . )

ggplot(data = dados_processing_ctl, aes(x = localGI, y = Longitudinal_correction , color = Longitudinal_correction, fill = Longitudinal_correction, alpha = 0.3)) + geom_boxplot()+theme_pubclean() + facet_grid(Session ~ . ) + stat_compare_means(method = "t.test")
...
```{r}
ggplot(data = dados_all, aes(x = Diagnostic, y = age, fill = machine, color = machine, alpha =0.3)) + geom_boxplot()+theme_pubclean() + stat_compare_means(method = "t.test")

dados_all_controle <- filter(dados_all, Diagnostic == "CONTROLE")

ggplot(data = dados_all_controle, aes(x = age, fill = machine, color = machine, alpha =0.3)) + geom_density()+theme_pubclean()

dados_all_controle <- filter(dados_all_controle, age >= 60 & age <= 80)

ggplot(data = dados_all_controle, aes(x = age, fill = machine, color = machine, alpha =0.3)) + geom_density()+theme_pubclean()

ggplot(data = dados_all_controle, aes(x = Diagnostic, y = age, fill = machine, color = machine, alpha =0.3)) + geom_boxplot()+theme_pubclean() + stat_compare_means(method = "t.test")

dados_all_controle <- filter(dados_all_controle, age >= 72 & age <= 73)
...
## NECESSIDADE DE MELHORIA - ACURACIA DA IDADE ##

```{r}
tabela_sujeitos$delta_age = tabela_sujeitos$age - tabela_sujeitos$Age

ggplot(data = tabela_sujeitos, aes(x = delta_age, color = Diagnostic, fill = Diagnostic, alpha =0.3)) + geom_density()+theme_pubclean()

ggplot(data = tabela_sujeitos, aes(x = delta_age, color = Diagnostic, fill = Diagnostic, alpha =0.3)) + geom_histogram()+theme_pubclean()

ggplot(data = filter(tabela_sujeitos, delta_age > 0.5), aes(x = delta_age, color = Diagnostic, fill = Diagnostic, alpha =0.3)) + geom_histogram()+theme_pubclean()
...
fit_comp <-
  lm(1 / 2 * logAvgThickness + logTotalArea ~ logExposedArea, data = filter(dados_datasetscomp, Sample == "IDOR" | Sample == "Mota&Houzel2015"), na.action=na.omit)

ggplot(filter(dados_datasetscomp, Sample == "IDOR" | Sample == "Mota&Houzel2015"), aes(log10(ExposedArea),
...
dados_datasetscomp_IHM <- filter(dados_datasetscomp, Sample == "IDOR" | Sample == "Mota&Houzel2015")
...
fit_comp_idor <-
  ...
  gplot(data = dados_hemi_v1,
  aes(logExposedArea, 1 / 2 * logAvgThickness + logTotalArea)) +
  ...
  theme_pubclean() + scale_color_discrete(name = "Diagnostic", labels = c("ALZ", "MCI", "CONTROL"))
...
```{r}
summary_dados_datasets <- filter(dados_datasetscomp, Sample != "IDOR" | Sample != "Mota&Houzel2015") %>%
...
ggplot(filter(dados_datasetscomp, Sample != "Mota&Houzel2015"), aes(log10(ExposedArea),
                               1 / 2 * log10(AvgThickness) + log10(TotalArea))) +
                               geom_point(aes(color = Sample)) +
                               geom_smooth(method = "lm", se = FALSE) +
                               theme_pubclean() + facet_grid(Sample ~ .) + stat_regline_equation()
```
...
model_1 = lm(log10(sqrt(AvgThickness) * TotalArea) ~ log10(ExposedArea) + hemi + log10(ExposedArea):hemi, data = dados_hemi_v1)

Anova(model_1, type = "II")

model_2 = lm(log10(sqrt(AvgThickness) * TotalArea) ~ log10(ExposedArea) + hemi , data = dados_hemi_v1)
...
model_3 = lm(log10(sqrt(AvgThickness) * TotalArea) ~ log10(ExposedArea) + Gender + log10(ExposedArea):Gender, data = dados_hemi_v1)

Anova(model_3, type = "II")

model_4 = lm(log10(sqrt(AvgThickness) * TotalArea) ~ log10(ExposedArea) + Gender , data = dados_hemi_v1)
...
ggplot(data = dados_hemi_v1, aes(Age, K,  color = Diagnostic)) +
geom_point() + geom_smooth(method = "lm") +
theme_pubclean()  + xlim(40, 95) + stat_cor(aes(color = Diagnostic)) + scale_color_discrete(name = "Diagnostic", labels = c("ALZ", "MCI", "CONTROL")) + labs(y = "log10(Offset K)")
...
model_5 = lm(log10(sqrt(AvgThickness) * TotalArea) ~ log10(ExposedArea) + Diagnostic + log10(ExposedArea):Diagnostic, data = dados_hemi_v1)

Anova(model_5, type = "II")

model_6 = lm(log10(sqrt(AvgThickness) * TotalArea) ~ log10(ExposedArea) + Diagnostic , data = dados_hemi_v1)
...
dados_kteorico_diag <-
  ...
  group_by(Diagnostic) %>%
  dplyr::summarise(
    avg_log_kteorico = mean(K),
    uci_log_kteorico = CI(K)[1],
    lci_log_kteorico = CI(K)[3]
  )
...
ggplot(
  ...
  geom_density(mapping = aes(x = K)) +
  labs(
    title = "Comparando o offset log10(K) para os diagnosticos",
    x = "Offset log10(K)",
    y = "Densidade",
    colour = "Diagnostic"
  ) +
...
ggplot(
  data = filter(
    ...
    machine == "Philips",
    Session == 1),
  aes(Age, K, color = Diagnostic)
) + geom_point() +
  geom_smooth(method = "lm") +
  labs(
    title = "Comparando o offset log10(K) pela Age",
    x = "Age",
    y = "log Offset (K)",
    colour = "Diagnostic"
  ) +
...
dados_lm_diag_age_corr <- dados_hemi_v1 %>%
  group_by(Diagnostic) %>%
  do(fit_diag_age_corr = lm(K_corr_decay ~ Age, data = .))
...
summary(aov(K_corr_decay ~Age*Diagnostic, data = dados_hemi_v1))

summary(aov(K_corr_decay ~Age+Diagnostic, data = dados_hemi_v1))

summary(lm(K_corr_decay ~Age+Diagnostic, data = dados_hemi_v1))
...
ggplot(
  data = filter(
    ...
    machine == "Philips",
    Session == 1),
  aes(Age, K_corr_decay, color = Diagnostic)
) + geom_point() +
  geom_smooth(method = "lm") +
  labs(
    title = "Comparando o offset log10(K) (corrigido para 25 anos) pela Age",
    x = "Age",
    y = "log Offset (K)",
    colour = "Diagnostic"
  ) +
...
bxplt_logK_diagnostic_Gender_agecorrected <-
  ggplot(data = dados_hemi_v1, aes(Diagnostic, K_corr_decay, color = Diagnostic)) +
  geom_boxplot() +
...
dados_lm_ROI <- dados_lobos_v1  %>%
  group_by(ROI) %>%
  do(fit_ROI = lm(log10(sqrt(AvgThickness) * TotalArea_corrected) ~ log10(SmoothArea_corrected), data = .))
...
dados_lm_diag_ROI <- dados_lobos_v1  %>%
  ...
  do(fit_diag_ROI = lm(log10(sqrt(AvgThickness) * TotalArea_corrected) ~ log10(SmoothArea_corrected), data = .))
...
levene <- leveneTest(K ~ Gender * Age * Diagnostic,
  data = dados_hemi_v1)
levene

aov_all_interval <-
  aov(K ~ Gender * Age_interval10 * Diagnostic,
  data = dados_hemi_v1
  )
...
levene2 <- leveneTest(K ~ Gender * Age * Diagnostic,
  data = dados_hemi_v1)
levene2

aov_all_corr <-
  aov(K_corr_decay ~ Gender * Diagnostic,
  data = dados_hemi_v1
  )
...
levene3 <- leveneTest(K_corr_decay ~ Gender * Diagnostic,
  data = dados_hemi_v1)
levene3
...
# ggplot(dados_hemi_v1,
#        aes(x = z_K_corr_decay, fill = Diagnostic)) +
#        geom_histogram(aes(y = ..density..),
#        colour = "black") +
#        stat_function(fun = dnorm, args = list(
#        mean = mean(dados$K_corr_decay[dados$Diagnostic == "CONTROLE"&
#        dados$ROI == "hemisphere"]),
#        sd = sd(dados$K_corr_decay[dados$Diagnostic == "CONTROLE"&
#        dados$ROI == "hemisphere"])
#        ))
...
ggplot(dados_hemi_v1,
       aes(x = Diagnostic, y = z_K_corr_decay, color = Diagnostic)) +
       geom_boxplot() + stat_compare_means(method = "anova") +
       theme_pubclean() +
  stat_compare_means(comparisons = my_comparisons, label = "p.signif")
...
dados <- filter(dados, ROI == "F"| ROI == "T"| ROI == "O"| ROI == "P"| ROI == "hemisphere", Session == 1)
dados_hemi_v1 <- filter(dados, ROI == "hemisphere", Session == 1)
dados_lobos_v1 <- filter(dados, ROI == "F"| ROI == "T"| ROI == "O"| ROI == "P"| ROI == "CC", Session == 1)

  
ggplot(dados_hemi_v1, aes(y = K_corr_decay, x = `TMT B-A`, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + stat_cor(aes(color = Diagnostic))

ggplot(dados_lobos_v1, aes(y = K_corr_decay, x = `TMT B-A`, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + facet_wrap(ROI ~ .) + stat_cor(aes(color = Diagnostic))

ggplot(dados_hemi_v1, aes(y = K_corr_decay, x = MMSE, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + stat_cor(aes(color = Diagnostic))

ggplot(dados_lobos_v1, aes(y = K_corr_decay, x = MMSE, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + facet_wrap(ROI ~ .) + stat_cor(aes(color = Diagnostic))

ggplot(dados_hemi_v1, aes(y = K_corr_decay, x = `A7/A5`, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + stat_cor(aes(color = Diagnostic))

ggplot(dados_lobos_v1, aes(y = K_corr_decay, x = `A7/A5`, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + facet_wrap(ROI ~ .) + stat_cor(aes(color = Diagnostic))

ggplot(dados_hemi_v1, aes(y = K_corr_decay, x = relogio, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + stat_cor(aes(color = Diagnostic))

ggplot(dados_lobos_v1, aes(y = K_corr_decay, x = relogio, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + facet_wrap(ROI ~ .) + stat_cor(aes(color = Diagnostic))

ggplot(dados_hemi_v1, aes(y = K_corr_decay, x = `DIGIT SPAN BACK`, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + stat_cor(aes(color = Diagnostic))

ggplot(dados_lobos_v1, aes(y = K_corr_decay, x = `DIGIT SPAN BACK`, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + facet_wrap(ROI ~ .) + stat_cor(aes(color = Diagnostic))
...
ggplot(dados_hemi_v1, aes(y = z_K_corr_decay, x = z_TMT_B_A, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + stat_cor(aes(color = Diagnostic))

ggplot(dados_lobos_v1, aes(y = z_K_corr_decay, x = z_TMT_B_A, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + facet_wrap(ROI ~ .) + stat_cor(aes(color = Diagnostic))

ggplot(dados_hemi_v1, aes(y = z_K_corr_decay, x = z_MMSE, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + stat_cor(aes(color = Diagnostic))

ggplot(dados_lobos_v1, aes(y = z_K_corr_decay, x = z_MMSE, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + facet_wrap(ROI ~ .) + stat_cor(aes(color = Diagnostic))

ggplot(dados_hemi_v1, aes(y = z_K_corr_decay, x = z_A7_A5, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + stat_cor(aes(color = Diagnostic))

ggplot(dados_lobos_v1, aes(y = z_K_corr_decay, x = z_A7_A5, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + facet_wrap(ROI ~ .) + stat_cor(aes(color = Diagnostic))

ggplot(dados_hemi_v1, aes(y = z_K_corr_decay, x = z_relogio, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + stat_cor(aes(color = Diagnostic))

ggplot(dados_lobos_v1, aes(y = z_K_corr_decay, x = z_relogio, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + facet_wrap(ROI ~ .) + stat_cor(aes(color = Diagnostic))

ggplot(dados_hemi_v1, aes(y = z_K_corr_decay, x = z_DIGIT_SPAN_BACK, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + stat_cor(aes(color = Diagnostic))

ggplot(dados_lobos_v1, aes(y = z_K_corr_decay, x = z_DIGIT_SPAN_BACK, color = Diagnostic )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + facet_wrap(ROI ~ .) + stat_cor(aes(color = Diagnostic))
...
ggplot(
  ...
  aes(y = K, x = log10(TotalArea_corrected_CC))
  ) + geom_point() + geom_smooth(method = "lm") + stat_cor() + theme_pubclean() + labs(x = "log10(CC Total Area)", y = "log10(Offset K)")
  
ggplot(
  data = filter(dados, ROI == "hemisphere"),
  aes(y = K, x = log10(SmoothArea_corrected_CC))
  ) + geom_point() + geom_smooth(method = "lm") + stat_cor() + theme_pubclean() + labs(x = "log10(CC Smooth Area)", y = "log10(Offset K)")

ggplot(
  data = filter(dados, ROI == "hemisphere"),
  aes(y = K_corr_decay, x = log_TotalArea_corr_decay_CC)
  ) + geom_point() + geom_smooth(method = "lm") + stat_cor() + theme_pubclean() + labs(x = "log10(CC Total Area) - deaged", y = "log10(Offset K) - deaged")
  
ggplot(
  data = filter(dados, ROI == "hemisphere"),
  aes(y = K_corr_decay, x = log_SmoothArea_corr_decay_CC)
...
ggplot(
  data = filter(dados, ROI == "hemisphere"),
  aes(y = K, x = log10(TotalArea_corrected_CC), color = Diagnostic)
...
ggplot(
  data = filter(dados, ROI == "hemisphere"),
  aes(y = K, x = log10(SmoothArea_corrected_CC), color = Diagnostic)
...
ggplot(
  data = filter(dados, ROI == "hemisphere"),
  aes(y = K_corr_decay, x = log_TotalArea_corr_decay_CC, color = Diagnostic)
...
ggplot(
  data = filter(dados, ROI == "hemisphere"),
  aes(y = K_corr_decay, x = log_SmoothArea_corr_decay_CC, color = Diagnostic)
...
ggplot(
  data = filter(dados, ROI == "hemisphere"),
  aes(y = K, x = log10(WM_volume_CC), color = Diagnostic)
...
correl_K_areat_decay_cc = rcorr(
  filter(dados, ROI == "hemisphere")$K_corr_decay,
...
ggplot(data = dados_hemi_v1_comp,
       ...
       x = log10(TotalArea_corrected_CC),
       color = Diagnostic,
       fill = Diagnostic
       )) + geom_point() + geom_smooth(method = "lm") + theme_pubclean() + scale_color_discrete(name = "Diagnostic", labels = c("ALZ", "MCI", "CONTROL")) + labs(x = "log10(TotalArea_CC)", y = "\varepsilon") + stat_cor() 
...
ggplot(data = dados_hemi_v1_comp,
       ...
       color = Diagnostic,
       fill = Diagnostic
       )) + geom_point() + geom_smooth(method = "lm", fullrange = TRUE) + theme_pubclean() + scale_color_discrete(name = "Diagnostic", labels = c("ALZ", "MCI", "CONTROL")) + labs(x = "log10(TotalArea_CC)", y = "\varepsilon") + xlim(0, 15) + stat_cor() 

ggplot(data = dados_hemi_v1_comp,
       aes(
       y = abs((K.L - K.R) / (
       var(K.L, K.R, na.rm = TRUE)
       ) ^ (1 / 4)),
...
ggplot(
  data = filter(dados, ROI == "hemisphere"),
  aes(y = K,x = log10(WhiteSurfArea_corrected), color = Diagnostic)
