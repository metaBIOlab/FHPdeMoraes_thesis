...
data_longcor_ses1_100 <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/resultados/data_longcor_ses1_100mm.txt")

data_longcor_ses1_100 <- data_longcor_ses1_100 %>% mutate(
  SUBJ = SubjectID,
  hemi = Hemisphere,
  ROI = "hemisphere",
...
data_longcor_ses1_100$hemi[data_longcor_ses1_100$hemi == "left"] <- "L"
data_longcor_ses1_100$hemi[data_longcor_ses1_100$hemi == "right"] <- "R"

# LOBOS----

# data_longcor_ses1_lobes_100 <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/resultados/data_longcor_ses1_lobes_100mm.txt")
# 
# data_longcor_ses1_lobes_100 <- data_longcor_ses1_lobes_100 %>% mutate(
#   SUBJ = SubjectID,
#   hemi = Hemisphere,
#   ROI = Lobe,
#   method = "CorticalFoldingTool",
...
# 
# data_longcor_ses1_lobes_100$hemi[data_longcor_ses1_lobes_100$hemi == "left"] <- "L"
# data_longcor_ses1_lobes_100$hemi[data_longcor_ses1_lobes_100$hemi == "right"] <- "R"
# 
# data_longcor_ses1_lobes_100$ROI[data_longcor_ses1_lobes_100$ROI == 1] <-
#   "F"
# data_longcor_ses1_lobes_100$ROI[data_longcor_ses1_lobes_100$ROI == 2] <-
#   "P"
# data_longcor_ses1_lobes_100$ROI[data_longcor_ses1_lobes_100$ROI == 3] <-
#   "T"
# data_longcor_ses1_lobes_100$ROI[data_longcor_ses1_lobes_100$ROI == 4] <-
#   "O"
# # data_longcor_ses1_lobes_100$nROI[data_longcor_ses1_lobes_100$nROI == 5] <- "Insula"
# 
# data_longcor_ses1_lobes_100$ROI <- as.factor(data_longcor_ses1_lobes_100$ROI)
