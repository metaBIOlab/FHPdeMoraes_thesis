...
data <-
  read_csv("~/Documentos/Gyrification/data/resultados/data_zkt2extra.txt")
...
data_lobes <-
  read_csv(
    "~/Documentos/Gyrification/data/resultados/data_zkt2extra_lobes.txt"
  )

data_lobes <- data_lobes %>% mutate(ROI = as.character(Lobe))

# aseg_stats_ZK <- read_table2("~/idor/Gyrification/data/resultados/aseg_stats_ZK.txt") %>%
...
tabela_sujeitos <-
  read_excel("~/Documentos/Gyrification/data/t1w fase 2 freesurfer.xlsx")
...
datat2 <-
  read_csv("~/Documentos/Gyrification/data/resultados/data_zkt2.txt")
...
data_lobest2 <-
  read_csv(
    "~/Documentos/Gyrification/data/resultados/data_zkt2_lobes.txt"
  )
