...
data_longcor_ses1_30 <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/resultados/data_longcor_ses1_30mm.txt")

data_longcor_ses1_30 <- data_longcor_ses1_30 %>% mutate(
  SUBJ = SubjectID,
  hemi = Hemisphere,
  ROI = "hemisphere",
...
data_longcor_ses1_30$hemi[data_longcor_ses1_30$hemi == "left"] <- "L"
data_longcor_ses1_30$hemi[data_longcor_ses1_30$hemi == "right"] <- "R"

# LOBOS----

# data_longcor_ses1_lobes_30 <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/resultados/data_longcor_ses1_lobes_30mm.txt")
# 
# data_longcor_ses1_lobes_30 <- data_longcor_ses1_lobes_30 %>% mutate(
#   SUBJ = SubjectID,
#   hemi = Hemisphere,
#   ROI = Lobe,
#   method = "CorticalFoldingTool",
...
# 
# data_longcor_ses1_lobes_30$hemi[data_longcor_ses1_lobes_30$hemi == "left"] <- "L"
# data_longcor_ses1_lobes_30$hemi[data_longcor_ses1_lobes_30$hemi == "right"] <- "R"
# 
# data_longcor_ses1_lobes_30$ROI[data_longcor_ses1_lobes_30$ROI == 1] <-
#   "F"
# data_longcor_ses1_lobes_30$ROI[data_longcor_ses1_lobes_30$ROI == 2] <-
#   "P"
# data_longcor_ses1_lobes_30$ROI[data_longcor_ses1_lobes_30$ROI == 3] <-
#   "T"
# data_longcor_ses1_lobes_30$ROI[data_longcor_ses1_lobes_30$ROI == 4] <-
#   "O"
# # data_longcor_ses1_lobes_30$nROI[data_longcor_ses1_lobes_30$nROI == 5] <- "Insula"
# 
# data_longcor_ses1_lobes_30$ROI <- as.factor(data_longcor_ses1_lobes_30$ROI)
